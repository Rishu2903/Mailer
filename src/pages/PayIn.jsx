...
const PayIn = () => {
    return (
        <div>
            <TopHeader text="Pay In" subText='Fast, Local Payment(APM) and wallet payments for web, app, eCommerce and gaming platform.' />
            <div className="max-w-6xl mx-auto mb-10 mt-16 px-4">
