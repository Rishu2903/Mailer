            ...
            <section className="bg-gray-100 py-16 px-6 md:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div className="text-center p-6 bg-gradient-to-r from-blue-200 via-transparent to-blue-300  rounded-lg shadow-lg hover:bg-pink-50 transition-alll">
                        ...
                        <p className="text-gray-600">Accept payments from credit cards, Local Payment(APM), wallets, and more—all through one integration.</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6 text-center md:text-left">
                        <img
                            ...
                            className="rounded-lg shadow-xl max-w-xs transform hover:scale-105 transition-all duration-500"
                             width="150"
                        />
                        <p className="text-gray-700 text-lg">Step 1: Collect Payments with Pavoyaa</p>
                    </div>
