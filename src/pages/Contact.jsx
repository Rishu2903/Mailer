...
const Contact = () => {
  ...
  return (
     <>
      <TopHeader text="Contact Us" subText="Welcome to Pavoyaa - Let's work together"/>
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="text-center max-w-3xl mx-auto mb-16">
      ...
      <p className="text-gray-600">
        Connect with our team for support, collaboration, or learn more how Pavoyaa can help your business.
      </p>
    </div>
    ...
    <div className="w-full lg:w-1/2 space-y-6">
        {[
          ...
          { icon: <FaTelegramPlane />, title: "Support Telegram", text: "Follow Us" },
             { icon: <FaTelegramPlane />, title: "Sale Telegram", text: "Follow Us" },
          { icon: <FaEnvelopeOpen />, title: "Email", text: "support@Pavoyaa.com" }]
          .map((item, idx) => (
  ...
  href={
    item.title === "Email"
      ? `mailto:${item.text}`
      : item.title === "Support Telegram"
      ? "https://t.me/tranzactx"
       : item.title === "Sale Telegram"
      ? "https://t.me/pavoyaa"
      : "#"
  }
      ...
      <div className="w-full lg:w-1/2">
        <form className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <input type="text" placeholder="Enter your website Url" className="form-input" />
          </div>
